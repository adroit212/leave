        ...
        <div style="background-image: url('img/banner.jpg')" class="inner-banner-w3ls d-flex align-items-center text-center">
            <div class="container">
                ...
                <ul class="breadcrumb-parent d-flex justify-content-center">
                    ...
                    <li class="breadcrumb-nav active  text-capitalize" aria-current="page">All Leave Applications</li>
                </ul>
            </div>
        </div>
        <!-- //inner banner -->
                    ...
                    <div class="card mt-3 my-3">
                        ...
                        <div class="card card-body">
                            <table class="table table-primary">
                                ...
                                <tbody>
                                    <?php
                                    $get_applications = mysqli_query($conn, "select * from applications where leavestatus<>'cancelled'");
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form onsubmit="return confirm('Please confirm your action!')" method="post" class="p-3">
                            ...
                            <div id="btn_cont" class="right-w3l text-right">
        ...
        <script>
                                    function openJsModal(raw_jsondata) {
                                        ...
                                        if (leavestatus === "pending") {
                                            document.getElementById('btn_cont').removeAttribute('hidden');
                                        } else {
                                            document.getElementById('btn_cont').setAttribute('hidden', 'hidden');
                                        }
