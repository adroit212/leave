        ...
        <div style="background-image: url('img/banner.jpg')" class="inner-banner-w3ls d-flex align-items-center text-center">
            <div class="container">
                ...
                <ul class="breadcrumb-parent d-flex justify-content-center">
                    ...
                    <li class="breadcrumb-nav active  text-capitalize" aria-current="page">Expired Leave Applications</li>
                </ul>
            </div>
        </div>
        <!-- //inner banner -->
                    ...
                    <div class="card mt-3 my-3">
                        ...
                        <div class="card card-body">
                            <table class="table table-primary">
                                ...
                                <tbody>
                                    <?php
                                    $get_applications = mysqli_query($conn, "select * from applications where leavestatus='expired'");
