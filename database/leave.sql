...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 04, 2020 at 02:38 PM
...
('admin', 'administrator', 'null', 'admin', 'a');
...
--
ALTER TABLE `states`
  MODIFY `state_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=38;COMMIT;
