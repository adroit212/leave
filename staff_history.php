...
$det = mysqli_fetch_array(mysqli_query($conn, "select fullname from users where userid='$sid'"));
        ...
        <div style="background-image: url('img/banner.jpg')" class="inner-banner-w3ls d-flex align-items-center text-center">
            <div class="container">
                ...
                <ul class="breadcrumb-parent d-flex justify-content-center">
                    ...
                    <li class="breadcrumb-nav active  text-capitalize" aria-current="page">Staff Leave Application History</li>
                </ul>
            </div>
        </div>
        <!-- //inner banner -->
                ...
                <div class="col-md-12">
                    <div class="card mt-3 my-3">
                        <div class="card card-header">
                            <h4><?php echo $fullname ?> Leave Records</h4>
                        </div>
                        <div class="card card-body">
                            <table class="table table-primary">
                                ...
                                <tbody>
                                    <?php
                                    $get_applications = mysqli_query($conn, "select * from applications where userid='$sid'");
